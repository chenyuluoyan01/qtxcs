    ...
    <div class="view-main">
        ...
        <div class="i-form">
            <Form :ref="formData.rel" :model="formData.rel" :label-width="120">
                ...
                <FormItem label="品牌管理：" class="formMust">
...
export default {
  ...
  methods: {
    ...
    save() {
      let _this = this;
      if(this.initP.province==""||this.initP.city==""||this.initP.district==""){
      ...
      if (this.formData.rel.factorysPictureArr.length == 0) {
        ...
        if($.isArray(this.formData.rel.factorysPictureArr)){
