let Api = {
  ...
  goods:{
    ...
    get:Host+'goods/gatGoods.do?method=sunny.fix.goods.fand.from.factory',
  ...
  //维修厂接口
  factory:{
    upExcel:  Host+'factory/gatFactory.do?method=sunny.fix.factory.paint.import',
    downloadExcel: Host+'factory/gatFactory.do?method=sunny.fix.factory.paint.export',
    ...
    goods:{
      ...
      getById:Host+'factory/gatFactory.do?method=sunny.fix.factory.goods.fandByGoodsId',
